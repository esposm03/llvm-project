...
#ifndef LLVM_MC_MCSECTIONVSBF_H
#define LLVM_MC_MCSECTIONVSBF_H
...
class MCSectionVsbf final : public MCSection {
  unsigned UniqueID;
  ...
  MCSectionVsbf(StringRef Name, SectionKind K, unsigned SegmentFlags,
